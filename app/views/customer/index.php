                        ...
                        <div class="body-table">
                            ...
                            <div class="pagination">
                                ...
                                <?php for ($i = 1; $i <= $data['totalPages']; $i++): ?>
                                    <a class="page__numbers" href="<?= BASEURL;?>/customer/<?php echo $i; ?>"><?php echo $i; ?></a>
                                <?php endfor; ?>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="modal-body" id="banyak">
        ...
        <form action="<?= BASEURL; ?>/customer/tambah" method="POST">
            ...
            <div class="form-group-modal buttons">
                <button class="btn btn-success" type="submit" id="save" idbtn="success">Save</button>
                <button class="btn btn-danger" type="button" id="close" idbtn="error">Close</button>
            </div>
        </form>
    </div>
</div>
